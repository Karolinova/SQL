...
The original version focused on identifying missing values and displaying results using RAISE NOTICE - [Validate empty columns](../Validate%20empty%20columns/).
