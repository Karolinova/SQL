...
The original version focused on identifying missing values and displaying results using RAISE NOTICE - [Walidacja pustych kolumn](SQL/Validate%20empty%20columns/).
...
```
SELECT * from walidacja_pustych_kolumn_tabela('dane_polisowe', variadic array	['data_wyst_polisy','ubezpieczajacy','posrednik']);